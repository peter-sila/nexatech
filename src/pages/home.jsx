...
import '../css/home.css'
import bg from '../assets/Programming-bg.jpg'
  ...
  return(
    <div className="home">
      ...
      <div className="why-choose-us">
        ...
        <div className="cards">
          <div className="card">
            <img src={AI_Software} alt="Production-Ready Scalability" />
          ...
          <div className="card">
            <img src={Invisible} alt="Hyper-Efficient Automation" />
          ...
          <div className="card">
            <img src={Innovative_IT} alt="Cryptographic Data Protection" />
